...
| [scripts/audiobook_script/run_comparator_loop.py](../scripts/audiobook_script/run_comparator_loop.py) | **Audiobook comparator loop** — fully automated Qwen draft+judge pipeline; PatchApplier; async parallel; 5 hard + 4 scored gates; manual_review_queue routing |
