...
|------|-------|--------|---------|
| e1_immediate.md | Email 1 | Immediate on contact created | Your Cyclic Sighing tool is here |
...
2. Trigger: Contact Created → Filter: Tag = `funnel_burnout_reset`
...
- Tool link (Cyclic Sighing): https://phoenixprotocolbooks.com/breathwork/tools/cyclic-sighing.html
