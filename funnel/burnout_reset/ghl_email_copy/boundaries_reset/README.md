...
|------|-------|--------|---------|
| e1_immediate.md | Email 1 | Immediate on contact created | Your Extended Exhale tool is here |
| e2_24h.md | Email 2 | +24 hours | One more reset — 5 Senses Grounding |
...
2. Trigger: Contact Created → Filter: Tag = `funnel_boundaries_reset`
...
- Tool link (Extended Exhale): https://phoenixprotocolbooks.com/breathwork/tools/extended-exhale.html
- Second tool link (5 Senses Grounding): https://phoenixprotocolbooks.com/breathwork/tools/five-senses-grounding.html?utm_content=email2_practice
