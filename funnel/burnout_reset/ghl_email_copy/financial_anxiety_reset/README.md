# GHL Email Copy — Financial Anxiety Hub
...
|------|-------|--------|---------|
| e1_immediate.md | Email 1 | Immediate on contact created | Your Triangle Breathing tool is here |
...
2. Trigger: Contact Created → Filter: Tag = `funnel_financial_anxiety_reset`
...
- Tool link (Triangle Breathing): https://phoenixprotocolbooks.com/breathwork/tools/triangle-breathing.html
