...
|------|-------|--------|---------|
| e1_immediate.md | Email 1 | Immediate on contact created | Your Tonglen tool is here |
...
2. Trigger: Contact Created → Filter: Tag = `funnel_grief_reset`
...
- Tool link (Tonglen): https://phoenixprotocolbooks.com/breathwork/tools/tonglen.html
