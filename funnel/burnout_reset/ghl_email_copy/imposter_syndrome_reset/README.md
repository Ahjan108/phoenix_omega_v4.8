# GHL Email Copy — Imposter Syndrome Hub
...
|------|-------|--------|---------|
| e1_immediate.md | Email 1 | Immediate on contact created | Your Sigh of Relief tool is here |
...
2. Trigger: Contact Created → Filter: Tag = `funnel_imposter_syndrome_reset`
...
- Tool link (Sigh of Relief): https://phoenixprotocolbooks.com/breathwork/tools/sigh-of-relief.html
