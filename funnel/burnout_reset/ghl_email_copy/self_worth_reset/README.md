...
|------|-------|--------|---------|
| e1_immediate.md | Email 1 | Immediate on contact created | Your Loving-Kindness Breathing tool is here |
...
2. Trigger: Contact Created → Filter: Tag = `funnel_self_worth_reset`
...
- Tool link (Loving-Kindness Breathing): https://phoenixprotocolbooks.com/breathwork/tools/loving-kindness-breathing.html
