...
| `03_consumer_language_by_topic.yaml` | 3. Consumer vs. clinical | **NEW:** `config/marketing/consumer_language_by_topic.yaml` | ⬜ Awaiting research |
| `04_invisible_scripts.yaml` | 4. Persona × topic scripts | **NEW:** `config/marketing/invisible_scripts_by_persona_topic.yaml` | ⬜ Awaiting research |
