...
**Operational docs (content team / assembly):** [../docs/assembly/SOMATIC_BOOK_BLUEPRINT.yaml](../docs/assembly/SOMATIC_BOOK_BLUEPRINT.yaml) (somatic book 10-slot contract, exercise cadence, emotional curve); [../docs/authoring/AUTHOR_ASSET_WORKBOOK.md](../docs/authoring/AUTHOR_ASSET_WORKBOOK.md) (pen-name author assets); [../docs/writing/GOLDEN_PHOENIX_ATOM_UPGRADE_GUIDE.md](../docs/writing/GOLDEN_PHOENIX_ATOM_UPGRADE_GUIDE.md) (persona micro-stakes, promotion workflow). **Exercise registry:** [../SOURCE_OF_TRUTH/exercises_v4/README.md](../SOURCE_OF_TRUTH/exercises_v4/README.md) (11 types, registry.yaml, candidate/approved). **Practice library:** [../SOURCE_OF_TRUTH/practice_library/README.md](../SOURCE_OF_TRUTH/practice_library/README.md) (inbox → ingest → normalize → validate; EXERCISE backstop); [../docs/PRACTICE_LIBRARY_TEACHER_FALLBACK.md](../docs/PRACTICE_LIBRARY_TEACHER_FALLBACK.md) (teacher fallback with doctrine wrapper). **Teacher Mode system reference:** [../docs/TEACHER_MODE_SYSTEM_REFERENCE.md](../docs/TEACHER_MODE_SYSTEM_REFERENCE.md) (modules, scripts, config, artifacts); **invariants:** [../TEACHER_MODE_INVARIANTS.md](../TEACHER_MODE_INVARIANTS.md).
